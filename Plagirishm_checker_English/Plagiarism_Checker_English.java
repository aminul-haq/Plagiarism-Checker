...
public class Plagiarism_Checker_English {

    static HashMap<String, String> wordRoot = new HashMap<>();
    static HashMap<String, String> shortFormWords = new HashMap<>();
    ...
    public static void main(String[] args)throws Exception {
        ...
        loadWords(dictionary, wordRoot, shortFormWords);
    ...
    static class Node {
        ...
        void convertString() {
            ...
            for(String key : shortFormWords.keySet()) {
                modified = modified.replaceAll(key, shortFormWords.get(key));
            }
            splits = modified.split(" ");
            for(int i = 0; i < splits.length; i++) {
                String s = splits[i];
                String base = getBaseWord(s);
               // debug(s, base, getBaseWord(base));
    ...
    static void loadWords(HashSet<String> dictionary, HashMap<String, String> wordRoot,
                          HashMap<String, String> shortFormWords) throws Exception {
        debug("Loading words...");
        ...
        //
        in = new Scanner(new FileInputStream("synonyms.txt"));
        while (in.hasNextLine()) {
        ...
        //
        in = new Scanner(new FileInputStream("short_Form_Words.txt"));
        while (in.hasNext()) {
            String a = in.next(), b = in.nextLine();
            shortFormWords.put(a, b);
        }
